...
Firstly, the ingredient list, it is divided, so you'll see the ingredients for the wontons first and then, the ingredients for the sauce.

After that, you'll see the recipe itself with the steps to follow, firstly, to make the sauce and then for the wontons.
